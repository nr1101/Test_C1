# Тестовое задание на роль Fullstack AQA
...
Проект содержит:
- Тест создания папки — Tests/CreateFolderTest.cs
- Тест создания дела — Tests/CreateCaseTest.cs
...
Данные для авторизации указваются в Utils/Config.cs.